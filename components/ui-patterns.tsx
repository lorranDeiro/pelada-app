...
// ============================================================================
// ⭐ STAR RATING COMPONENT - Dinâmico com preenchimento fracionário
// ============================================================================
...
export const StarRating: React.FC<StarRatingProps> = ({
  ...
  const rating = Math.min(Math.max(value || 0, 0), maxStars);
  const fullStars = Math.floor(rating);
  const partialPercent = ((rating - fullStars) * 100);
      ...
      <div className="flex gap-0.5">
        {stars.map((i) => (
          <div key={i} className="relative">
            ...
            <svg
              className={cn(starSize, 'text-surface-border')}
              fill="currentColor"
              viewBox="0 0 20 20"
            >
            ...
            {/* Filled star foreground (full or partial) */}
            <div
